...
class UpdateCivitasRequest extends FormRequest
{
    ...
    {
        $civitasId = $this->route('civita') ? $this->route('civita')->id : $this->route('civitas');

        return [
            'name' => ['required', 'string', 'max:255'],
            'nip' => ['nullable', 'string', 'max:50', Rule::unique('civitas', 'nip')->ignore($civitasId)],
